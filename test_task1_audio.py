...
public_test_set.iloc[:, 4] = (tsk2_np==0).astype(int)
public_test_set.iloc[:, 5] = (tsk2_np==1).astype(int)
public_test_set.iloc[:, 6] = (tsk2_np==2).astype(int)
public_test_set.iloc[:, 7] = (tsk2_np==3).astype(int)
...
public_test_set.iloc[:, 9] = (pred_list==0).astype(int)
public_test_set.iloc[:, 10] = (pred_list==1).astype(int)
public_test_set.iloc[:, 11] = (pred_list==2).astype(int)
